...
const MOCK_PRODUCTS = [
  {
    ...
    description:
      "精緻的手工編織花籃，搭配緞帶蝴蝶結，適合婚禮花童或派對桌面裝飾，營造浪漫氛圍。",
  },
  {
    id: 2,
    name: "氣球電動充氣機",
    ...
    price: 200,
    deposit: 300,
    images: ["https://i.postimg.cc/NG4HHc6d/23-24-2025-12-22de-ying-xiang.jpg"],
    description:
      "雙孔高效能設計，充氣速度快且散熱佳，附贈多種吹嘴，讓派對氣球佈置變得輕鬆省力。",
  },
  {
    id: 3,
    name: "金属拱形背景架",
  ...
  },
  {
    ...
    price: 300,
    deposit: 500,
    images: ["https://i.postimg.cc/g2TchYkg/23-39-2025-12-22de-ying-xiang.jpg"],
    description:
      "閃耀的玫瑰金亮片材質，在燈光照射下波光粼粼。尺寸有80*180/120*220cm兩款",
  },
  {
    id: 5,
    name: "LED夾燈串",
    ...
    price: 30,
    deposit: 60,
    images: ["https://i.postimg.cc/XJZsvk1P/23-47-2025-12-22de-ying-xiang.jpg"],
    description:
      "暖白光色溫，附帶透明夾子可懸掛拍立得照片或明信片，為夜晚的派對增添溫馨回憶，長度1.5M。",
  },
  {
    id: 6,
    name: "多功能氣球架",
    ...
    price: 100,
    deposit: 200,
    images: ["https://i.postimg.cc/PJvfK93M/00-04-2025-12-23de-ying-xiang.jpg"],
  ...
  },
  {
    ...
    price: 100,
    deposit: 200,
    images: ["https://i.postimg.cc/QtgJrWCs/deng.jpg"],
  ...
  },
  {
    ...
    price: 500,
    deposit: 1000,
    images: ["https://i.postimg.cc/L6S6Xgs1/gong-men-2026-01-07-213657.jpg"],
    description: "",
  },
  {
    id: 10,
    ...
    price: 250,
    deposit: 500,
    images: ["https://i.postimg.cc/G2MJ2nFD/bei-er.jpg"],
  ...
  },
  {
    ...
    price: 80,
    deposit: 160,
    images: ["https://i.postimg.cc/YSLDWKqK/poker.jpg"],
    description: "",
  },
];
...
const ProductImage = ({ src, alt }) => {
  ...
  const fallback =
    "https://images.unsplash.com/photo-1496337589254-7e19d01ced44?auto=format&fit=crop&q=80&w=800";
...
export default function App() {
  ...
  return (
    <div
      className="min-h-screen font-sans text-[#4A4A4A] selection:bg-[#D4AF37] selection:text-white"
    ...
    >
        ...
        >
          ...
          >
            ...
            <div className="bg-[#FDFBF7] p-6 border-b border-[#E6DDD0] flex justify-between items-center relative overflow-hidden">
              ...
              <button
                onClick={() => setShowAIPlanner(false)}
                className="z-10 text-[#888] hover:text-[#2C2C2C]"
              >
                <X size={24} />
              </button>
            </div>
              ...
              {!aiPlan ? (
                ...
                <div className="space-y-8 animate-fade-in">
                  <div className="text-center space-y-3">
                    <h4 className="text-2xl md:text-3xl font-serif text-[#D4AF37]">
                      {aiPlan.title}
                    </h4>
                    <p className="text-[#666] italic font-light">
                      "{aiPlan.vibe}"
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      {MOCK_PRODUCTS.filter((p) =>
                        aiPlan.recommendedIds.includes(p.id)
                      ).map((product) => (
                        <div
                          key={product.id}
                        ...
                        >
                          ...
                          <div className="text-center">
                            <p className="text-xs text-[#2C2C2C] font-serif truncate">
                              {product.name}
                            </p>
                  ...
                  <div className="bg-[#FDFBF7] p-5 border border-[#E6DDD0]">
                    ...
                    <ul className="space-y-2">
                      {aiPlan.tips.map((tip, i) => (
                        <li
                          key={i}
                          className="text-sm text-[#555] font-light flex gap-3"
                        >
                          <span className="text-[#E6DDD0] font-serif text-lg leading-none">
                            {i + 1}.
                          </span>
                          {tip}
                        </li>
              ...
              <div className="flex-grow">
                <p className="text-[#666] text-sm leading-6 md:leading-7 font-light tracking-wide min-h-[100px]">
                  {selectedProduct.description ||
                    "此商品暫無詳細說明。歡迎聯繫我們了解更多細節。"}
                </p>
              </div>

              <div className="pt-6 mt-4 space-y-3 border-t border-[#F5F5F5]">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#888] tracking-widest">
                    租金 Rent
                  </span>
      ...
      <header className="relative w-full h-[70vh] md:h-[85vh] flex items-center justify-center overflow-hidden bg-[#F3EFE9]">
        ...
        <div className="relative z-10 text-center max-w-4xl px-6 space-y-6 md:space-y-8">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 border border-[#D4AF37] rounded-full text-[#D4AF37] text-[10px] md:text-xs tracking-[0.2em] uppercase font-medium bg-white/50 backdrop-blur-sm mb-2 md:mb-4">
            <Star size={10} className="md:w-3 md:h-3" fill="#D4AF37" /> Premium
            Party Rental
          </div>
          <h2 className="text-4xl sm:text-5xl md:text-7xl font-serif font-medium text-[#2C2C2C] leading-tight">
            讓您的派對
            <br />
            <span className="italic font-light text-[#D4AF37]">閃耀</span>{" "}
            著獨特的光芒
          </h2>
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24">
        <div className="flex flex-col items-center mb-12 md:mb-20 space-y-6">
          <h3 className="text-2xl md:text-3xl font-serif font-bold text-[#2C2C2C]">
            精選系列
          </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10 md:gap-y-16">
          {MOCK_PRODUCTS.filter(
            (p) =>
              selectedCategory === "全部系列" || p.category === selectedCategory
          ).map((product) => (
            <div
              key={product.id}
      ...
      <footer className="bg-[#1A1A1A] text-white/60 py-8 text-sm font-light tracking-wide">
        <div className="max-w-7xl mx-auto px-6 text-[10px] md:text-xs text-center flex justify-center items-center">
          <span>
            &copy; 2026 Hermione's Party Library. All rights reserved.
          </span>
        </div>
      </footer>
    </div>
